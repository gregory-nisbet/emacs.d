...
;; changes for including whether leader keys are assigned or not
;; also moving archive to "C" so as not to conflict with c
;; todo better policy for what things are allowed to be leader locally
